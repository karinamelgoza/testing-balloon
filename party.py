...
def most_and_least_common_type(treats):
    ...
    >>> treats = [{'type': 'dessert'},{'type': 'drink'},{'type': 'drink'},{'type': 'drink'},{'type': 'drink'},{'type': 'appetizer'},{'type': 'appetizer'}]
    >>> most_and_least_common_type(treats)
    ('drink', 'dessert')
    >>> treats = [{'type': 'dessert'}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'dessert')
    >>> treats = [{'type': 'dessert'},{'type': 'drink'},{'type': 'drink'},{'type': 'appetizer'},{'type': 'appetizer'}]
    >>> most_and_least_common_type(treats)                                          
    ('drink', 'dessert')
    >>> treats = [{'type': 'dessert'},{'type': 'drink'},{'type': 'appetizer'},{'type': 'appetizer'}]
    >>> most_and_least_common_type(treats)                                          
    ('appetizer', 'dessert')
    >>> treats = []
    >>> most_and_least_common_type(treats)
